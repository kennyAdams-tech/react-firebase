  ...
  return (
    <div className='m-5 p-5 card shadow '>
        <div className="d-flex gap-5 mx-auto mb-3">
            <div className={login ? 'h2 btn btn-secondary px-5' : 'h2'} onClick={()=>setLogin(true)}>Login</div>
            <div className={!login ? 'h2 btn btn-secondary px-5' : 'h2'} onClick={()=>setLogin(false)}>SignUp</div>
